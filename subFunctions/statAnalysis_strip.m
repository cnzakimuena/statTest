...
function statAnalysis_strip(type1_para1, type2_para1, test)

chartColors1.c1 = rgb('Grey');
chartColors1.c2 = rgb('Red'); 
paraSize = 1;
fSize = 40;
lSize = 4;
...
figName = {'sepal length' 'sepal width'};
for b = 1:size(type1_para1,2)
    ...
    stripchart(conVio_t1t2, conVec_t1t2, chartColors1, ...
        'ViolinAlpha', 1, 'EdgeColor', [0 0 0], 'ShowMean', true);
    ...
    % title({'Iris flowers','sepal comparision'})
