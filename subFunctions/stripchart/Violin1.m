classdef Violin1 < handle
    ...
    methods
        function obj = Violin1(data, pos, varargin)
            ...
            % COMMENT LINES BELOW TO REMOVE DATA POINTS
            obj.ScatterPlot = ...
                scatter(pos + jitter.*jitterstrength, data, 400, 'filled');

            % COMMENT LINES BELOW TO REMOVE VIOLIN (KEEP ONLY DATA POINTS)
%             plot the violin
